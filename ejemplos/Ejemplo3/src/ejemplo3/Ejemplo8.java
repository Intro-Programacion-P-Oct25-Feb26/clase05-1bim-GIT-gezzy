...
public class Ejemplo8 {
    ...
    public static void main(String[] args) {
        ...
        double promedio = 2;
        String mensaje = ""; // El mensaje a presentar ahora es una variable
        ...
        if ((promedio >= 7.5) && (promedio <= 10)) {
            ...
            if ((promedio >= 5) && (promedio < 7.5)) {
                ...
                //       + "promedio: %.2f\n", promedio);
                //mensaje = "El estudiante entra en SUSPENSO con un promedio "
                //        + "de: " + promedio; CONCATENACION SIMPLE
                mensaje = String.format("Estudiante en suspenso con un "
                        + "promedio: %.2f\n", promedio);
                // CONCATENACION FORMAT
                ...
                if ((promedio >= 3) && (promedio < 5)) {
                    ...
                    mensaje = String.format(
                            "Estudiante en recuperacion con un "
                            + "promedio: %.2f\n", promedio);
                } else {
                    if ((promedio >= 0) && (promedio < 3)) {
                        ...
                        if (promedio < 0) {
                            //System.out.printf("La nota %.2f (negativo) "
                            //        + "esta fuera de rango\n", promedio);
                            mensaje = String.format("La nota %.2f (negativo) "
                                    + "esta fuera de rango\n", promedio);
                        } else {
                            //System.out.printf("La nota %.2f (positivo) "
                            //        + "esta fuera de rango\n", promedio);
                            mensaje = String.format("La nota %.2f (positivo) "
                                    + "esta fuera de rango\n", promedio);
                        }
                    }
                }
        ...
        System.out.printf("%s\n", mensaje); // Presentamos la variable mensaje
    }
}
